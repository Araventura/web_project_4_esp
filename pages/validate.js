...
export const toggleFormButton = (formElement) => {
    const popupInputs = Array.from(formElement.querySelectorAll(".popup__input-wrapper .popup__input"));
...
export const resetInputValidation = (popup) => {
    const inputList = Array.from(popup.querySelectorAll(".popup .popup__container .form .popup__input-wrapper .popup__input"));
    const errorMessages = Array.from(popup.querySelectorAll(".popup .popup__container .form .popup__input-wrapper span"));
